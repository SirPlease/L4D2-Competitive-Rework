...
public void OnPluginStart()
{
	...
	g_hItemAnnounceType		= CreateConVar("l4d2_item_hint_announce_type", "2", "物品提示的方式 (0:禁用, 1:聊天框, 2:弹出提示, 3:屏幕中心)", FCVAR_NOTIFY, true, 0.0, true, 3.0);
	...
	g_hItemCvarColor		= CreateConVar("l4d2_item_hint_glow_color", "", "物品发光颜色 (无内容 = 关闭发光)", FCVAR_NOTIFY);
	g_hItemInstructorHint	= CreateConVar("l4d2_item_instructorhint_enable", "0", "在物品上方显示物品提示 (0:禁用, 1启用)", FCVAR_NOTIFY, true, 0.0, true, 1.0);
	...
	g_hSpotMarkAnnounceType		= CreateConVar("l4d2_spot_marker_announce_type", "3", "标记提示的方式 (0:禁用, 1:聊天框, 2:弹出提示, 3:屏幕中心)", FCVAR_NOTIFY, true, 0.0, true, 3.0);
	...
	g_hSpotMarkInstructorHint	= CreateConVar("l4d2_spot_marker_instructorhint_enable", "0", "在标记上方创建标记提示 (0:禁用, 1:启用)", FCVAR_NOTIFY, true, 0.0, true, 1.0);
	...
	g_hInfectedMarkCoolDown		= CreateConVar("l4d2_infected_marker_cooldown_time", "3", "玩家使用语音菜单“Z”键的“看”标记发光特殊感染者的冷却时间", FCVAR_NOTIFY, true, 0.0);
	g_hInfectedMarkUseRange     = CreateConVar("l4d2_infected_marker_use_range", "1.0", "玩家多远可以标记特殊感染者", FCVAR_NOTIFY, true, 1.0);
	...
	g_hInfectedMarkAnnounceType	= CreateConVar("l4d2_infected_marker_announce_type", "0", "感染者提示的方式 (0:禁用, 1:聊天框, 2:弹出提示, 3:屏幕中心)", FCVAR_NOTIFY, true, 0.0, true, 3.0);
	...
	g_hInfectedMarkCvarColor   	= CreateConVar("l4d2_infected_marker_glow_color", "0", "特殊感染者标记颜色 （无内容=禁用特殊感染者发光）", FCVAR_NOTIFY);
	g_hInfectedMarkWitch    	= CreateConVar("l4d2_infected_marker_witch_enable", "0", "可以标记Witch (0:禁用, 1:启用)", FCVAR_NOTIFY, true, 0.0, true, 1.0);
